package pe.edu.upc.sysadap.spring.security.jobs;
...
import pe.edu.upc.sysadap.spring.security.tasklet.EmailSendingTasklet;
import pe.edu.upc.sysadap.spring.security.tasklet.FileDeletingTasklet;
...
//		return stepBuilderFactory.get("step1").tasklet(fileDeletingTasklet()).build();
	...
	public EmailSendingTasklet emailSendingTasklet() {
		EmailSendingTasklet tasklet = new EmailSendingTasklet();
		return tasklet;
	}
